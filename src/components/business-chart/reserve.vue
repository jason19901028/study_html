  ...
  <div class="chart-h5-wrap">
    <div v-if="!!resData">
      <div class="page-tittle-wrap">
        ...
        >库存金额趋势图</div>
      <div class="title-top">
        <div class="section-map">库存金额趋势图</div>
        <div class="chart-box">
      ...
      <div class="section-box">
        <div class="section-title">库存金额明细</div>
        <ul class="list-box">
          <li><span>时间</span> <span>库存金额<i>(元)</i></span></li>
          <li
...
export default {
  ...
  methods: {
    ...
    getToolTipContent (params, ticket, callback) {
      return '<div style="text-align: left">' + this.currentItem.date + '<br/>库存金额: ￥' + this.currentItem.amount + '</div>'
    },
    initChart () {
    ...
    updateChart () {
      ...
      let chartMoney = this.resData.entryDeliverReportVO.stockAmount
      this.listChartMoney = Array.from(this.resData.entryDeliverReportVO.stockAmount || []).reverse()
